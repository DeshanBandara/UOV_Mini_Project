...
if (isset($_GET['approve'])) {
    $id = $_GET['approve'];
    $query = "UPDATE `vehicle_reservation` SET `status` = 1 WHERE `id` = '$id'";
    $result = mysqli_query($connect, $query);
    if ($result) {
    ...
    $id = $_GET['reject'];
    $query = "UPDATE `vehicle_reservation` SET `status` = 2 WHERE `id` = '$id'";
    $result = mysqli_query($connect, $query);
    if ($result) {
        header('location:vehicle.php');
    }
...
if (isset($_POST['message']) && isset($_POST['id'])) {
    ...
    $query = "UPDATE `vehicle_reservation` SET `message` = '$message' WHERE `id` = '$id'";
    $result = mysqli_query($connect, $query);
    if ($result) {
        header('location:vehicle.php');
    }
    ...
    <body>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a href="vehicle.php?approve=<?php echo $row['id'] ?>" class="btn btn-success">Approve</a>
                                            <a href="vehicle.php?reject=<?php echo $row['id'] ?>" class="btn btn-danger">Reject</a>
                                        </div>
                                    </td>
                                </tr>
        ...
        <script>
            function viewAppInModal(id) {
                ...
                r.open("GET", "view_vehicle.php?id=" + id, true);
                r.send();
            }
        </script>
    </body>
